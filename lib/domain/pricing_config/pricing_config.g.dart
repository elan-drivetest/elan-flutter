...
_$PricingConfigImpl _$$PricingConfigImplFromJson(Map<String, dynamic> json) =>
    _$PricingConfigImpl(
      ...
      instructorRate: json['instructor_rate'] as num? ?? 4000,
      instructorBasePrice: json['instructor_base_price'] as num? ?? 12000,
      averageDistancePerHour: json['average_distance_per_hour'] as num? ?? 50,
      maxPickupDistanceKm: json['max_pickup_distance_km'] as num? ?? 300,
...
Map<String, dynamic> _$$PricingConfigImplToJson(_$PricingConfigImpl instance) =>
    <String, dynamic>{
      ...
      'instructor_base_price': instance.instructorBasePrice,
      'average_distance_per_hour': instance.averageDistancePerHour,
      'max_pickup_distance_km': instance.maxPickupDistanceKm,
